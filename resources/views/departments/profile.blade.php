...
<div class="card shadow-sm">
    <div class="card-header bg-white d-flex align-items-center">
        ...
        <h5 class="mb-0">Department Profile</h5>
    </div>
    <div class="card-body">
        <dl class="row mb-0">
            ...
            <dt class="col-sm-4"><i class="bi bi-building me-1"></i>Department</dt>
            <dd class="col-sm-8">{{ $user->department }}</dd>
            @if($department)
                <dt class="col-sm-4"><i class="bi bi-info-circle me-1"></i>Department Info</dt>
                <dd class="col-sm-8">{{ $department->description ?? 'N/A' }}</dd>
            @endif
        </dl>
        ...
        @endif
        <form method="POST" action="{{ route('department.profile.password') }}">
            @csrf
            <div class="mb-2">
